...
\newcommand{\titel}{IT-Based textgeneration using NLP methods}
\newcommand{\artderarbeit}{Bachelor Thesis}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Tim Löhr}
\newcommand{\studiengang}{Business Informatics and Management}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
