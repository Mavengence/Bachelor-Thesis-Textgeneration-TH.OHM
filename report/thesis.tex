...
\newcommand{\titel}{IT-based Automatic Text Summarization with the use of Text Generation Methods}
\newcommand{\artderarbeit}{Bachelor Thesis}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Tim Löhr}
\newcommand{\studiengang}{Information Systems and Management}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{3060802}
...
\include{content/2_state_of_the_art}
\include{content/3_prototyp}
\include{content/4_evaluation}
