...
\newcommand{\titel}{IT-based text generation using NLP methods}
\newcommand{\artderarbeit}{Bachelor Thesis}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Tim Löhr}
\newcommand{\studiengang}{Business Information Systems and Management}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
