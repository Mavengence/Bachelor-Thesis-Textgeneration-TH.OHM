...
Making changes like the improvement tips in the model architecture requires a lot of knowledge, so the easiest but most expensive way is increasing the training data size first. 
